...
describe User do
  ...
  it 'should create a new instance if validates method succeeds' do
  User.create!(@attr)
end
  ...
  describe 'password validation' do
    # modied this from to should instead of should_not to pass the test 
    it 'should require a password' do
      User.new(@attr.merge(:password => '', :password_confirmation => '')).should respond_to :password
    end
